                                    ...
                                    {filtered.length === 0 ? (
                                        ...
                                        filtered.map(doc => (
                                            <tr key={doc.id}>
                                                ...
                                                <td>
                                                    <button className="doctor-action-btn" title="Edit (Not Implemented)" onClick={() => alert('Edit feature pending implementation')}><span role="img" aria-label="edit">✏️</span></button>
                                                    <button className="doctor-action-btn" title="Delete" onClick={() => handleDeleteClick(doc)}><span role="img" aria-label="delete">🗑️</span></button>
                                                </td>
                                            </tr>
                                        ))
                                    )}
