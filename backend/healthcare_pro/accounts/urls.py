...
from .views import auth_views, user_views, admin_views, owner_views
...
urlpatterns = [
    ...
    path('owner/doctor-performance/', owner_views.owner_doctor_performance, name='owner_doctor_performance'),
    path('owner/hospital-analytics/', owner_views.owner_hospital_analytics, name='owner_hospital_analytics'),
    path('owner/upcoming-appointments/', owner_views.owner_upcoming_appointments, name='owner_upcoming_appointments'),
]