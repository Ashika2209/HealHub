...
class Doctor(models.Model):
    ...
    performance_rating = models.IntegerField(null=True, blank=True, help_text="Performance rating 1-5")
    department_category = models.CharField(max_length=50, null=True, blank=True, help_text="Department category for analytics")
