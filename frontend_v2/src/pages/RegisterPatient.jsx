    ...
    return (
        <AdminLayout active="register-patient" setAdminLoggedIn={setAdminLoggedIn}>
            ...
            <div className="register-header">
                <button className="back-btn" onClick={() => navigate('/admin/patients')}>&larr; Back to Patients</button>
                <div className="register-title-block">
                    <div className="register-title">Register New Patient</div>
                    <div className="register-desc">Enter patient information below</div>
                </div>
            </div>
