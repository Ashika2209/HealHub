                                    ...
                                    {filtered.length === 0 ? (
                                        ...
                                        filtered.map(p => (
                                            <tr key={p.id}>
                                                ...
                                                <td>{p.lastVisit}</td>
                                                <td>
                                                    <button className="patient-action-btn" title="Edit (Not Implemented)" onClick={() => alert('Edit feature pending implementation')}><span role="img" aria-label="edit">✏️</span></button>
                                                    <button className="patient-action-btn" title="Delete" onClick={() => handleDeleteClick(p)}><span role="img" aria-label="delete">🗑️</span></button>
                                                </td>
                                            </tr>
                                        ))
                                    )}
